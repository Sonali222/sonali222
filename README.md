...
LLM-powered job matching platform using Streamlit and Gemini API.
Designed data ingestion pipelines, normalized job datasets, and built analytics-ready tables with accessibility focused features.
